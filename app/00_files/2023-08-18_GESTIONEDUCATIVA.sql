...
--
-- Servidor: localhost
-- Tiempo de generación: 18-08-2023 a las 22:29:58
...
--
ALTER TABLE `GRUPO_MATERIAS`
  MODIFY `grupo__id` int(5) NOT NULL AUTO_INCREMENT;
